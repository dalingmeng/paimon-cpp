...
WriteContext::WriteContext(const std::string& root_path, const std::string& commit_user,
                           ...
                           const std::string& io_temp_directory,
    ...
    : root_path_(root_path),
      ...
      executor_(executor),
      io_temp_directory_(io_temp_directory),
...
WriteContextBuilder& WriteContextBuilder::WithIOTempDirectory(const std::string& temp_dir) {
    impl_->io_temp_directory_ = temp_dir;
    return *this;
}
...
Result<std::unique_ptr<WriteContext>> WriteContextBuilder::Finish() {
    ...
    auto ctx = std::make_unique<WriteContext>(
        ...
        impl_->io_temp_directory_, impl_->specific_file_system_,
